...
$(function(){$(".bg-holder").parallaxScroll({friction:.95,direction:"vertical"})});
/// Begin JS for Push Menu http://callmenick.com/post/slide-and-push-menus-with-css3-transitions
...
var app = {
    ...
    initalizeExpandingContent: function(){
      	$(".advisory-council-member-description").hide();
  		$(".advisory-council-close").click(function(){
          $(".advisory-council-member-description").not($(this).next()).slideUp();
  		$(this).closest(".advisory-council-member").find('.advisory-council-member-name').toggleClass("color-green");
