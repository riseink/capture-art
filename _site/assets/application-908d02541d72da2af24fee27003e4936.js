	...
	initializeMap: function(){
		if ($('#map').length > 0) {
			...
			google.maps.event.addListener(map, 'zoom_changed', function() {
			    ...
			    var maxPixelSize = 64; //restricts the maximum size of the icon, otherwise the browser will choke at higher zoom levels trying to scale an image to millions of pixels
